...
import com.slilio.xiaohashu.distributed.id.generator.biz.core.segment.dao.impl.IDAllocDaoImpl;
...
public class SegmentService {
  ...
  public SegmentService() throws SQLException, InitException {
    ...
    boolean flag =
        Boolean.parseBoolean(properties.getProperty(Constants.LEAF_SEGMENT_ENABLE, "true"));
    if (flag) {
      // Config dataSource
