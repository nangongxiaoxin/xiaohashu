package com.slilio.xiaohashu.distributed.id.generator.biz.core.snowflake;
...
import com.slilio.xiaohashu.distributed.id.generator.biz.core.common.Utils;
...
public class SnowflakeIDGenImpl implements IDGen {
  ...
  public SnowflakeIDGenImpl(String zkAddress, int port, long twepoch) {
    ...
    Preconditions.checkArgument(
        workerId >= 0 && workerId <= maxWorkerId, "workerID must gte 0 and lte 1023");
  }
