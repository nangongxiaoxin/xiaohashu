...
import com.slilio.xiaohashu.search.biz.enums.NotePublishTimeRangeEnum;
import com.slilio.xiaohashu.search.biz.enums.NoteSortTypeEnum;
...
public class NoteServiceImpl implements NoteService {
  ...
  public Response<Long> rebuildDocument(RebuildUserDocumentReqDTO rebuildUserDocumentReqDTO) {
    ...
    // 遍历查询结果，将每条记录同步到elasticsearch索引中
    for (Map<String, Object> recordMap : result) {
      // 创建索引请求对象，指定索引名称
