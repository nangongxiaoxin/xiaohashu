...
import com.slilio.xiaohashu.distributed.id.generator.biz.core.segment.SegmentIDGenImpl;
import com.slilio.xiaohashu.distributed.id.generator.biz.core.segment.model.LeafAlloc;
import com.slilio.xiaohashu.distributed.id.generator.biz.core.segment.model.SegmentBuffer;
import com.slilio.xiaohashu.distributed.id.generator.biz.model.SegmentBufferView;
...
public class LeafMonitorController {
  ...
  /**
   * the output is like this: { "timestamp": "1567733700834(2019-09-06 09:35:00.834)", "sequenceId":
   * "3448", "workerId": "39" }
   */
