...
public class UserCollectCountShardingXxlJob {
  ...
  public void userCollectCountShardingJobHandler() throws Exception {
    ...
    for (; ; ) {
      ...
      List<Long> userIds =
          selectMapper.selectBatchFromDataAlignUserCollectCountTempTable(
      ...
      userIds.forEach(
          userId -> {
            ...
            int userCollectTotal =
                selectMapper.selectUserCollectCountFromNoteCollectionTableByUserId(userId);
            ...
            if (count > 0) {
              ...
              if (hashKey) {
                ...
                redisTemplate
                    .opsForHash()
                    .put(redisKey, RedisKeyConstants.FIELD_COLLECT_TOTAL, userCollectTotal);
              }
            }
          });
