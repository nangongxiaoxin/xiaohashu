package com.slilio.xiaohashu.search.biz.canal;
...
import com.slilio.xiaohashu.search.biz.domain.mapper.SelectMapper;
import com.slilio.xiaohashu.search.biz.enums.NoteStatusEnum;
import com.slilio.xiaohashu.search.biz.enums.NoteVisibleEnum;
import com.slilio.xiaohashu.search.biz.index.NoteIndex;
import com.slilio.xiaohashu.search.biz.index.UserIndex;
...
public class CanalSchedule implements Runnable {
      ...
      case UPDATE -> {
        ...
        if (Objects.equals(status, StatusEnum.ENABLE.getValue()) && Objects.equals(isDeleted, 0)) {
          ...
          syncNotesIndexAndUserIndex(userId);
            ...
            && Objects.equals(isDeleted, 1)) { // 用户状态为禁用、被逻辑删除
  ...
  private void deleteUserDocument(String documentId) throws Exception {
    ...
    // 执行删除，将指定文档从Elasticsearch索引中删除
    restHighLevelClient.delete(deleteRequest, RequestOptions.DEFAULT);
  }

  /**
   * 同步用户索引、笔记索引（可能多条） 批量操作使用bulk API实现
   *
   * @param userId
   */
