package com.slilio.xiaohashu.auth.runner;
...
import com.slilio.xiaohashu.auth.domain.mapper.PermissionDOMapper;
import com.slilio.xiaohashu.auth.domain.mapper.RoleDOMapper;
import com.slilio.xiaohashu.auth.domain.mapper.RolePermissionDOMapper;
...
public class PushRolePermissions2RedisRunner implements ApplicationRunner {
  ...
  @Resource private PermissionDOMapper permissionDOMapper;
  @Resource private RolePermissionDOMapper rolePermissionDOMapper;
  ...
  public void run(ApplicationArguments args) {
    ...
    try {
      ...
      if (CollUtil.isNotEmpty(roleDOS)) {
        ...
        Map<Long, List<Long>> roleIdPermissionIdsMap =
            rolePermissionDOS.stream()
                .collect(
        ...
        // 权限 ID - 权限 DO
        Map<Long, PermissionDO> permissionIdDOMap =
        ...
        roleIdPermissionDOMap.forEach(
            (roleId, permissionDOS1) -> {
